...
export interface Article {
   ...
   */
  category: ('Featured This Month' | 'Related Articles' | 'Recently Posted')[];
  /**
   * Used for URL routing (e.g., articles/my-article). Auto-generate if left blank.
   */
  slug: string;
  updatedAt: string;
  createdAt: string;
