    ...
    <div className="container mx-auto p-8 pb-20 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <div className="relative">
        ...
        <h1 className="text-4xl font-bold tracking-light">
          ...
          <span className="block text-primary">at Fleek</span>
        </h1>
        <p className="mt-6 text-xl text-gray-300 leading-8">
          Fleek is India's largest subscription marketplace and management app with
          the top subscription discounts, and the tools to manage all your
          subscriptions ...
        </p>
      </div>
      <div className="flex mt-10 gap-4">
        <button className="px-8 py-3 rounded-lg border border-gray-600 hover:border-primary font-medium">
          About us
        </button>
