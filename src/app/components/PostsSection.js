...
const PostSection = async () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8 "id="blog">
            ...
            <div className="w-72">
            <h2 className="text-4xl font-bold text-light ">Latest from <br/>
            the blog</h2>
            </div>
                    ...
                    return (
                        ...
                        >
                            <article className="space-y-4">
                                <h3 className="text-2xl font-semibold text-light group-hover:text-purple-400 transition-colors mb-4">{post.title}</h3>
                            </article>
                        <div>
